    ...
    return (
        <div className='flex flex-col-reverse lg:flex-row items-center justify-center mx-[5%]'>
            <div className='text-center flex-1 lg:mx-auto mahin'>
                <h1 className='2xl:text-8xl 2xl:my-auto text-6xl 2xl:leading-28'>বাংলাদেশ <span className='text-cyan-400'>ইসলামি</span> ছাত্রশিবির</h1>
                <h4 className='text-4xl mt-2.5 mb-8 text-[#1a1919b6]'>ঢাকা মহানগর দক্ষিণ, <span className='text-[#000000]'>মাতুয়াইল পূর্ব থানা</span></h4>
